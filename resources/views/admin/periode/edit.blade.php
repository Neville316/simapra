...
<div class="max-w-2xl mx-auto">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Edit Periode PKL</h2>
        ...
        <form action="{{ route('admin.periode.update', $periode->id) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nama_periode" class="form-input" placeholder="Contoh: Ganjil 2024/2025" value="{{ old('nama_periode', $periode->nama_periode) }}" required autofocus>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="mb-5 md:mb-0">
                    ...
                    <input type="date" name="tanggal_mulai" class="form-input" value="{{ old('tanggal_mulai', $periode->tanggal_mulai) }}" required>
                    @error('tanggal_mulai')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-5 md:mb-0">
                    ...
                    <input type="date" name="tanggal_selesai" class="form-input" value="{{ old('tanggal_selesai', $periode->tanggal_selesai) }}" required>
