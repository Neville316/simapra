...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="card lg:col-span-1">
        <h2 class="text-lg font-bold text-gray-800 mb-4">Status Penempatan PKL</h2>
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 text-sm">
                            <span class="text-xs px-2 py-1 rounded-full {{ $item->status->color() }}">{{ $item->status->label() }}</span>
                        </td>
                    </tr>
                    @empty
